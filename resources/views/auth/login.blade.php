...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="{{asset('assets_admin/favicon.ico')}}" type="image/x-icon">
...
<script src="{{asset('assets_admin/plugins/jquery-validation/jquery.validate.js')}}"></script>

<!-- Custom Js -->
<script src="{{asset('assets_admin/js/admin.js')}}"></script>
<script src="{{asset('assets_admin/js/pages/examples/sign-in.js')}}"></script>
</body>
