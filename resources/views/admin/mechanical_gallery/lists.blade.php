...
@section('content')
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                MECHANICAL GALLERY
                                <small>All pictures taken from mechanical gallery</small>
                            </h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="#createPhotoModal" data-toggle="modal">Create New</a></li>
                                ...
                                @foreach($galleries as $gallery)
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        @if($gallery->extension == 'image')
                                            <a href="{{asset('image/mech_gallery')}}/{{$gallery->photo_name}}" data-sub-html="Demo Description">
                                                <img style="width: 100%;height: 229px" class="img-responsive thumbnail" src="{{asset('image/mech_gallery')}}/{{$gallery->photo_name}}">
                                            </a>
                                        @else

                                            <video style="width: 100%;height: 229px" class="thumbnail" controls>
                                                <source src="{{asset('image/mech_gallery')}}/{{$gallery->photo_name}}" type="video/mp4">
                                                <source src="{{asset('image/mech_gallery')}}/{{$gallery->photo_name}}" type="video/ogg">
                                        ...
                                        @if($gallery->status == 'on')
                                            <div class="switch" style="text-align: center;display: inline-block">
                                                <label style="color: red;font-weight: bold">OFF<input type="checkbox" value="{{$gallery->id}}" class="gallery_status" checked><span class="lever"></span><span style="color:green">ON</span></label>
                                            </div>
                                        @else
                                            <div class="switch" style="text-align: center;display: inline-block">
                                                <label style="color: red;font-weight: bold">OFF<input type="checkbox" value="{{$gallery->id}}" class="gallery_status"><span class="lever"></span><span style="color:green">ON</span></label>
                                            </div>
                                        @endif
                                        <button type="button" data-toggle="modal" data-target="#deleteMgalleryModal" style="text-align: center;display: inline-block;float: right"
    ...
    <div id="createPhotoModal" class="modal fade">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="padding: 15px">
                <form action="{{url('admin/create_mechanical_gallery')}}" method="post" enctype="multipart/form-data">
    ...
    <!-- Delete Modal HTML -->
    <div id="deleteMgalleryModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content modal-col-deep-orange">
                <form action="{{url('admin/delete_Mgallery')}}" method="post">
...
@section('script')
    ...
    <script>
        ...
        $(".gallery_status").click(function () {
            ...
            $.ajax({
                type:'post',
                url:url_base + 'admin/check_gallery',
                data:{
                    'id':$(this).val(),
        ...
        $('#deleteMgalleryModal').on('show.bs.modal',function(event) {
